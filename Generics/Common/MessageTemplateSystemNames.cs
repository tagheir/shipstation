namespace Generics.Common
{
    ...
    {
        public static string NEWITEMADDED(string itemname) => $"A new orderItem {itemname} has been added";

        public static string SHIPMENTDELIVERED(int shipmentNo) => $"Shipment#{shipmentNo} has been delivered";

        public static string SHIPMENTSHIPPED(int shipmentNo) => $"Shipment#{shipmentNo} has been shipped";

        public static string SHIPMENTADDED(int shipmentNo) => $"Shipment#{shipmentNo} has been added";
        ...
        /// </summary>
        public const string WishlistToFriendMessage = "StoreWishlist.EmailAFriend";
